...
<script>
import crud${className} from '@/api/${apiPath}/${changeClassName}'
...
export default {
  ...
  cruds() {
    return CRUD({ title: '${apiAlias}', url: 'api/${apiPath}/${changeClassName}', sort: '${pkChangeColName},desc', crudMethod: { ...crud${className} }})
  },
  data() {
    return {
      permission: {
